...
Trust coin is a protocol for writing cryptographically signed messages.  These message are used to issue or exchange virtual tokens by holders of public/private cryptographic key pairs.
